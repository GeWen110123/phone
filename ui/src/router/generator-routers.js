...
const constantRouterComponents = {
  ...
  'Home': () => import('@/views/module/Home'),

  'Facility': () => import('@/views/module/Facility'),

  'DeviceGroup': () => import('@/views/module/DeviceGroup'),

  'SystemUser': () => import('@/views/system/user'),
  'loginLog': () => import('@/views/monitor/logininfor'),
  'deviceLog': () => import('@/views/monitor/operlog'),

  'Allocation': () => import('@/views/module/Strategy/Allocation'),
  'Task': () => import('@/views/module/Strategy/Task'),
  'Video': () => import('@/views/module/Video'),

  'UserSearch': () => import('@/views/module/UserSearch'),
  'DetailPage': () => import('@/views/module/Video/detailPage.vue'),
