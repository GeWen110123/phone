package com.phone.common.utils.ip;
...
public class IpUtil {  
    ...
    public static void main(String[] args) {  
        ...
        String ip0="172.31.0.4/24";//ip  
       System.err.println(ip0.split("/")[0]);
       System.err.println(ip0.split("/")[1]);
        ...
        System.out.println("mysql中inet_aton():"+Long.valueOf(new BigDecimal(ipToDouble("45.54.19.4")+"").toString()));  
